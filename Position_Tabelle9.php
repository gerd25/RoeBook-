...
<div style="position:relative; left:160px; top:1.0cm">
 ...
 <form method="post" action="http://localhost/test/Abfrage_datum_auswahl3.php" >
  ...
  <form  action="http://localhost/test/Abfrage_datum_auswahl3.php" method="post" >

       <INPUT  TYPE = "RADIO" NAME="DVT" VALUE="PX">DVT
       <INPUT  TYPE = "RADIO" NAME="DVT" VALUE="OI">CT
       <INPUT  TYPE = "RADIO" NAME="DVT" VALUE="PZ">KB
       <INPUT  TYPE = "RADIO" NAME="DVT" VALUE="VT">ROEN1
 ...
 // $studien = $decodedData['Studies'][0];
  ...
  //##############################################################
         ?>
                                             ...
                                             <div position='relative; top:10'>
                                            <select name="Auswahl">
                                            <option value="IO">DVT</option>
                                            <option value="value2">CT</option>
                                            <option value="value3">PX</option>
